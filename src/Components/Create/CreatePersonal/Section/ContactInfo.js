...
const ContactInfo = ({ setProvinceMap, setDistrictMap, setWardMap }) => {
  ...
  return (
    <Row gutter={[16, 16]}>
      ...
      <Col xs={24} sm={6}>
        <Form.Item label="Quận/Huyện" name="districtContact">
          <Select
      ...
      <Col xs={24} sm={6}>
        <Form.Item label="Xã/Phường" name="wardContact">
          <Select
      ...
      <Col xs={24} sm={6}>
        <Form.Item label="Số nhà" name="houseNumberContact">
      ...
      <Col xs={24} sm={6}>
        <Form.Item
          ...
          rules={[
            ...
            { pattern: /^(\+84|0)[1-9]\d{8,9}$/, message: 'Số điện thoại không hợp lệ' }
          ]}
        >
